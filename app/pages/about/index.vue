...
<template>
  <div class="about">
    <h1>О нас</h1>
    <h3>Мы делаем шикарные украшения для вас</h3>
    <p>Duis rutrum dictum libero quis rutrum. Etiam sed neque aliquam, sollicitudin ante a, gravida
      arcu. Nam fringilla
      molestie velit, eget pellentesque risus scelerisque a. Nam ac urna maximus, tempor magna et,
      placerat urna.
